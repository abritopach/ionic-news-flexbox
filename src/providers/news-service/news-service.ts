...
export class NewsServiceProvider {
    ...
    data: any;
    static NEWS_ENDPOINT: string = 'https://newsapi.org/v1/articles?source=';
    ...
    getHeadlines(source) {
        ...
        return new Promise(resolve => {
            ...
            this.http.get(NewsServiceProvider.NEWS_ENDPOINT + source + '&sortBy=top&apiKey=019e79c431f342959264c7800168f771')
                .map(res => res.json())
                .subscribe(data => {
